...
假设一群朋友聚在一起打麻将，大家都在自己的小本子上记分。每局结束时，所有人都会把这一局的输赢同步写入账本，就像在区块链上添加了一个新的区块；随着牌局不断进行，这些记录按时间顺序串联成完整的“账本链”。因为账本分散在每个人手中，没有任何中心化的记账者，谁也无法单独篡改历史，这正体现了去中心化和不可篡改的特性。
